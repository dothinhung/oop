...
public class ObjectFactory {
    ...
    private final static QName _SubstractionResponse_QNAME = new QName("http://WebServices/", "substractionResponse");
    private final static QName _Division_QNAME = new QName("http://WebServices/", "division");
    private final static QName _DivisionResponse_QNAME = new QName("http://WebServices/", "divisionResponse");
    private final static QName _AdditionResponse_QNAME = new QName("http://WebServices/", "additionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://WebServices/", "multiplication");
    private final static QName _Substraction_QNAME = new QName("http://WebServices/", "substraction");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://WebServices/", "multiplicationResponse");
    private final static QName _Addition_QNAME = new QName("http://WebServices/", "addition");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "substractionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "substraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "multiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebServices/", name = "addition")
